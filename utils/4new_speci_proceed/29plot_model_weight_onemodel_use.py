...
conditions=['CK','CD','CE']#
species=['sorghum']#,'homo_C3','homo_C4','homo''wheat',,'indica_BGI','japonica','zeamays'
data_types=['KEGG','PPI','TF',]#
preds=[]
tf_embeds=[]
target_embeds=[]
x1s=[]
...
for data_type in data_types:
    for speci in species:
        if speci == 'homo' and data_type=='TF':
            continue
        for i,condition in enumerate(conditions):
            # if speci == 'sorghum' and condition=='CE':
            #     continue
            ic(data_type,speci,condition)
