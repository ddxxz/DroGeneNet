...
def embedding_plot(data_type,speci,condition,data,name):
    # 降维 - PCA
    ...
    plt.savefig(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/model_weight_embedding/{data_type}_{speci}_{condition}_{name}_embedding.png',bbox_inches='tight')
...
conditions=['CK']#'TF',,'CD','CE'
#species=['zeamays']#,'indica_BGI',,'japonica'
data_types=['PPI']#,,'KEGG','PPI'
preds=[]
tf_embeds=[]
target_embeds=[]
x1s=[]
    ...
    for speci in species:
        for i,condition in enumerate(conditions):
            ...
            with torch.no_grad():
                ...
                #ic(edge_index.device,values.device,num_nodes.device)
                ...
                for i in range(num_blocks_height):
                    for j in range(num_blocks_width):
                        plt.figure(figsize=(5, 5))  # 可以调整图像大小
                # if speci=='japonica' and data_type=='TF':
                #     i=2
                #     j=31
                #     plt.xlabel('Target',fontsize=30,weight='bold')
                #     plt.ylabel('TF',fontsize=30,weight='bold')
                # elif speci=='indica_BGI' and data_type=='TF':
                #     i=17
                #     j=58
                #     plt.xlabel('Target',fontsize=30,weight='bold')
                #     plt.ylabel('TF',fontsize=30,weight='bold')
                # elif speci=='zeamays' and data_type=='TF':
                #     i=2
                #     j=129
                #     plt.xlabel('Target',fontsize=30,weight='bold')
                #     plt.ylabel('TF',fontsize=30,weight='bold')
                # elif speci=='wheat' and data_type=='TF':
                #     i=6
                #     j=265
                #     plt.xlabel('Target',fontsize=30,weight='bold')
                #     plt.ylabel('TF',fontsize=30,weight='bold')

                # elif speci=='sorghum' and data_type=='TF':
                #     i=0
                #     j=56
                #     plt.xlabel('Target',fontsize=30,weight='bold')
                #     plt.ylabel('TF',fontsize=30,weight='bold')

                # elif speci=='japonica' and data_type=='KEGG':
                #     i=0
                #     j=12
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='indica' and data_type=='KEGG':
                #     i=4
                #     j=4
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='zeamays' and data_type=='KEGG':
                #     i=0
                #     j=8
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='wheat' and data_type=='KEGG':
                #     i=19
                #     j=52
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='sorghum' and data_type=='KEGG':
                #     i=10
                #     j=11
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')

                # elif speci=='japonica' and data_type=='PPI':
                #     i=0
                #     j=60
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='indica_BGI' and data_type=='PPI':
                #     i=0
                #     j=24
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='zeamays' and data_type=='PPI':
                #     i=2
                #     j=15
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='wheat' and data_type=='PPI':
                #     i=58
                #     j=137
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                # elif speci=='sorghum' and data_type=='PPI':
                #     i=32
                #     j=34
                #     plt.xlabel('Gene2',fontsize=30,weight='bold')
                #     plt.ylabel('Gene1',fontsize=30,weight='bold')
                    ...
                    #if speci=='japonica' and i==2 and j==31:
                    #'zeamays' and i==2 and j==129:# indica i==17 and j==58
                    # 计算当前子矩阵的起始行列索引
                    ...
                    #plt.colorbar()  # 显示颜色条
                    plt.title(f'{speci}-{condition}-adj1',fontsize=35,weight='bold',pad=10)

                    plt.savefig(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/attention_weight/test/{data_type}_{speci}_{condition}_adj1_{i}_{j}.png',bbox_inches='tight')
            ...
            # embedding_plot(data_type,speci,condition,input,'input')
            # embedding_plot(data_type,speci,condition,x0,'x0')
            # embedding_plot(data_type,speci,condition,x1,'x1')
            # embedding_plot(data_type,speci,condition,x2,'x2')
            # embedding_plot(data_type,speci,condition,x3,'x3')
