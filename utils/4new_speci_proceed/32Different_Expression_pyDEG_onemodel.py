...
for data_type in data_types:
    if data_type == 'TF':
        species=['sorghum']  #'homo_C3','homo_C4''wheat',,
    else:
        species = ['sorghum']#'homo_C3','homo_C4','homo''wheat',,
#for organ in organs:
    for speci in species:
        ...
        if test==1:
            ...
            if speci == 'sorghum':
                ...
                gene_map1 = dict(zip(map_txt['Protein stable ID'], map_txt['new_column']))
                data.index =  data.index.map(gene_map1)
            ic(data)
            #ic(data)
