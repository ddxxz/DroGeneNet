...
species_dict = {
    'TF': ['wheat','sorghum','homo_C3','homo_C4'],   #'indica_BGI',  'japonica','zeamays',
    'PPI': ['wheat','sorghum','homo','homo_C3','homo_C4'],   #'indica_BGI',  'japonica','zeamays',
    'KEGG': ['wheat','sorghum','homo','homo_C3','homo_C4']   #'indica',  'japonica','zeamays',
}
