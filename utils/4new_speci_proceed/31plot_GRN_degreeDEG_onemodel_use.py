...
for data_type in data_types:
    ...
    #             f'/home/win/4T/GeneDL/OSDrought_GCNAT_Link/plot/multispecies_modelresult/{speci}/{exp}_gene_num_water_deprivation.csv']
            ...
            combined_df_ck_cd = combined_df_ck_cd.sort_values(by='abs(log2FC)', ascending=False)
            ...
            combined_df_ck_ce = combined_df_ck_ce.sort_values(by='abs(log2FC)', ascending=False)
