...
#taes KGB	Triticum aestivum (bread wheat)
#sbi	KGB	Sorghum bicolor (sorghum)
...
# print(pathway_ids)
# # 创建保存 KGML 文件的目录
# output_dir <- paste0('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/', "sbi_kgml")
...
# 指定输入和输出目录
input_directory <- "/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/wheat/taes_kgml"
output_directory <- "/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/wheat/taes_edge"
