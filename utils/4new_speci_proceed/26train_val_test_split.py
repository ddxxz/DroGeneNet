...
for speci in ['wheat']:#'homo_C3','homo_C4','sorghum','homo','indica_BGI','japonica','zeamays'
    for layer in ['PPI']:#'TF',,'KEGG'
        datapath=f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/{layer}/{speci}'
