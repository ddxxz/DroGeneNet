        ...
        # treats=['leaf','root']#['CK','CD']#
            ...
            for i,gene_sets in enumerate(all_gene_sets):
                ...
                #for file in files:
                    ...
                    data=pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/EXP_Degree_intersection_DEG/{data_type}_{speci}_{treat}_degree_exp_intersection.csv')
                    gene_list = data['0']
                    ...
                    enr = gp.enrichr(gene_list=gene_list,#所需查询gene_list，可以是一个列表，也可为文件（一列，每行一个基因）
                                    ...
                                    outdir=f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/EXP_Degree_intersection_GO/{data_type}_{speci}',#输出目录
                                    top_term=20,
                                    cutoff=0.9,#pvalue阈值
                                    )
                    #ic(enr.results)
                    ...
                    dot_png = f"exp_{speci}_{funcs[i]}_{treat}" + "_" + "dot" + ".png"
                    ...
                    df= dotplot(enr.results,
                            ...
                            #figsize=(3,5),
                            xticklabels_rot=45,
                            title=f'GO Top15 Pathway DEG {speci} {funcs[i]} {treat}', 
                            show_ring=True,
                            #marker='o',
                            cmap='RdBu',
                    ...
                    df.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/EXP_Degree_intersection_GO/{data_type}_{speci}_{funcs[i]}_{treat}_GO.csv',index=False)
