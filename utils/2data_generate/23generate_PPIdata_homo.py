...
df_selected = pd.read_csv('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/TF_Target.csv')
...
# 保存到CSV文件
output_csv_path = '/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/regulate_unique_genes.csv'  # 设定输出文件名
...
df = pd.read_csv("/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/TF_Target.csv")

with open('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/ExpressionData_unique_networkfilter.pkl', 'rb') as file:
    # 使用 pickle 加载数据
...
ic(len(merged_df))
merged_df.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/ALL_Genefile.csv')



#print(target)
pd.DataFrame({'TF': list(dict.fromkeys(selected_rows['TF'])), 'index': list(dict.fromkeys(tf))}).to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/TF.csv')
pd.DataFrame({'Gene': list(dict.fromkeys(selected_rows['Target'])), 'index': list(dict.fromkeys(target))}).to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/Target.csv')

pd.DataFrame(unique_genes).to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/unique_genes.csv', index=False)
# 保存转换后的索引对索引的文件
ic(data)
data.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/index_mapped_TF_Target.csv', index=False)
...
install()
# 读取已有的CSV文件
df = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/index_mapped_TF_Target.csv')
gene_file = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/ALL_Genefile.csv')
...
# 保存为新的CSV文件
all_samples.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/all_labels.csv',index=False)
...
# 读取unique gene的CSV文件
unique_gene_df = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/unique_genes.csv')
...
# 保存筛选后的结果为新的CSV文件
filtered_expression_data_df.to_pickle('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/homo/ExpressionData_unique_networkfilter.pkl')
