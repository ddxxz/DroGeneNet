...
speci='zeamays'
# 定义文件夹路径
folder_path = f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/{speci}/zma_edge'  # 替换为实际的文件夹路径
...
#============================在uniprot网站，从KEGG转为Uniprot，再从UniProtKB AC/ID转换成Ensembl Genomes==========================
