...
#df = pd.read_csv("/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/japonica/PROTEIN1_Protein2.csv")
...
ic(gene_index)
import json
filename = "/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/gene_index.json"
...
ic(len(merged_df))
merged_df.to_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/ALL_Genefile.csv')



#print(protein2)
pd.DataFrame({'protein1': list(dict.fromkeys(selected_rows['protein1'])), 'index': list(dict.fromkeys(protein1))}).to_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/protein1.csv')
pd.DataFrame({'protein2': list(dict.fromkeys(selected_rows['protein2'])), 'index': list(dict.fromkeys(protein2))}).to_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/protein2.csv')

pd.DataFrame(unique_genes).to_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/unique_genes.csv', index=False)
# 保存转换后的索引对索引的文件

#ic(data['PROTEIN1'].max(),data['Protein2'].max())
data.to_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/index_mapped_protein1_protein2.csv', index=False)
...
install()
# 读取已有的CSV文件
df = pd.read_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/index_mapped_protein1_protein2.csv')
gene_file = pd.read_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/ALL_Genefile.csv')
...
# 保存为新的CSV文件
all_samples.to_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/all_labels.csv',index=False)
...
# 读取unique gene的CSV文件
unique_gene_df = pd.read_csv(f'/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/unique_genes.csv')
...
# 保存筛选后的结果为新的CSV文件
filtered_expression_data_df.to_pickle('/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/japonica/ExpressionData_unique_networkfilter.pkl')
