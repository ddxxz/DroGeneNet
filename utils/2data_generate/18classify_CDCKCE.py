...
for speci in ['indica_BGI','japonica','zeamays']: #'homo','indica',
    
    datapath = f"/home/win/4T/GeneDL//data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/{speci}"
    # 加载CSV文件
