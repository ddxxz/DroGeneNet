...
# file_path1 = '/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/regulation_merged_Zma.txt'  # 这里替换为你的文本文件路径
# file_path2 = '/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/Zma_PROTEIN1_list.txt'  # 这里替换为你的文本文件路径
...
# # 保存到CSV文件
# pd.DataFrame(unique_values).to_csv('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/genes.csv', index=False)  # 第一列的数据保存为 column1.csv

# files3 = '/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/gene_id_trans.txt'
...
# regulation.to_csv('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/PROTEIN1_Protein2.csv',index=False)

# PROTEIN1_list = pd.concat([column3_mapped, df2.iloc[:, 2]],axis=1)
# PROTEIN1_list.columns = ['PROTEIN1','Family']
# PROTEIN1_list.to_csv('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/PROTEIN1_family.csv',index=False)

# filtered_df = regulation[regulation['PROTEIN1'].str.startswith('Zm') & regulation['Protein2'].str.startswith('Zm')]
# filtered_df.to_csv('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PROTEIN1/indica/PROTEIN1_Protein2.csv',index=False)

# #-----------------------------------222生成PROTEIN1索引文件------------------------------------------第一步  与调控关系交叉会减少基因数目
import pandas as pd

df = pd.read_csv("/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/indica_kegg_gene.csv")
# with open('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/PPI/indica/indica_PPI_gene.pkl', 'rb') as file:
#     # 使用 pickle 加载数据
#     df = pickle.load(file)
...
ic(gene_index)
import json
filename = "/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/gene_index.json"
...
ic(len(merged_df))
merged_df.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/ALL_Genefile.csv')



#print(protein2)
pd.DataFrame({'protein1': list(dict.fromkeys(selected_rows['protein1'])), 'index': list(dict.fromkeys(protein1))}).to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/protein1.csv')
pd.DataFrame({'protein2': list(dict.fromkeys(selected_rows['protein2'])), 'index': list(dict.fromkeys(protein2))}).to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/protein2.csv')

pd.DataFrame(unique_genes).to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/unique_genes.csv', index=False)
# 保存转换后的索引对索引的文件

#ic(data['PROTEIN1'].max(),data['Protein2'].max())
data.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/index_mapped_protein1_protein2.csv', index=False)
...
install()
# 读取已有的CSV文件
df = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/index_mapped_protein1_protein2.csv')
gene_file = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/ALL_Genefile.csv')
...
# 保存为新的CSV文件
all_samples.to_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/all_labels.csv',index=False)
...
# 读取unique gene的CSV文件
unique_gene_df = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/unique_genes.csv')
...
# 保存筛选后的结果为新的CSV文件
filtered_expression_data_df.to_pickle('/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/data/batch_correction_data/KEGG/indica/ExpressionData_unique_networkfilter.pkl')
