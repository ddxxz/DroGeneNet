...
for data_type in data_types:
    ...
    for speci in species:
        for treat in ['CK_CD','CK_CE']:
            data = pd.read_csv(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/supernode_GRN_photosynthesis/{data_type}_{speci}_{treat}_go.csv')
            ic(final_df)
