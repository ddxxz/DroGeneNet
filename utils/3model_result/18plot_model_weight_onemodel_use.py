...
conditions=['CK','CD','CE']#'TF',
#species=['zeamays']#,'indica_BGI',,'japonica'
data_types=['KEGG','TF','PPI']#,
preds=[]
tf_embeds=[]
target_embeds=[]
x1s=[]
...
for data_type in data_types:
    if data_type== 'KEGG':
        species=['zeamays','indica','japonica']#,
    else:
        species=['zeamays','japonica','indica_BGI']#
    for speci in species:
        for i,condition in enumerate(conditions):
            ...
            with torch.no_grad():
                ...
                plt.savefig(f'/home/win/4T/GeneDL/data_output/GRN_result/Batch_correction/out/model_result/attention_weight/{data_type}_{speci}_{condition}_adj1_{i}_{j}.png',bbox_inches='tight')
