...
# import pandas as pd
# import numpy as np
# with open('/home/win/16t1/Deeplearning/data_output/GRN_result/Batch_correction/data/batch_correction_out/expression/zeamays_expression_batchcorrection.pkl', 'rb') as file:
...
# with open('/home/win/16t1/Deeplearning/data_output/GRN_result/Batch_correction/data/batch_correction_out/expression/indica_expression_batchcorrection.pkl', 'rb') as file:
#     indica_data = pd.DataFrame(pickle.load(file))
# indica_data.reset_index(inplace=True)
# ic(indica_data.shape)
# with open('/home/win/16t1/Deeplearning/data_output/GRN_result/Batch_correction/data/batch_correction_out/expression/japonica_expression_batchcorrection.pkl', 'rb') as file:
...
# ic(final_df)
# final_df.to_pickle('/home/win/16t1/Deeplearning/data_output/GRN_result/Batch_correction/data/batch_correction_out/expression/homo_expression_batchcorrection.pkl')
...
# filtered_exp_df.to_pickle('/home/win/4T/GeneDL/OSDrought_GCNAT_Link/data/multispecies/TF_regulation_filter_data/homo/ExpressionData_unique_networkfilter.pkl')
