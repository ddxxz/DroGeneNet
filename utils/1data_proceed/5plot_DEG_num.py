...
data = {
    'Group': ['indica-up', 'indica-down', 'japonica-up', 'japonica-down', 'zeamays-up', 'zeamays-down'],
    'GeneNum': [943, 1479, 1928, 322, 1531, 1165]   #homo 86 59
}
...
ic(unique_groups)
colors = [(77,187,213), (77,187,213),(230,75,53),(230,75,53),(0,160,135),(0,160,135)]
...
plt.savefig('/home/win/16t1/Deeplearning/data_output/GRN_result/Batch_correction/out/deg_num.png',bbox_inches='tight')
